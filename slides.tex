...
\usefolder{UoB}
\usetheme{UoBslides}
%\usetheme[compress]{UoBslides}     % Compress the margins
%\usetheme[nourl]{UoBslides}        % Remove the footer with the URL
%\usetheme[nowatermark]{UoBslides}  % Remove the watermark from the title page
...
\institute{Faculty of Engineering \\ School of Computer Science, Electrical and Electronic Engineering and Engineering Maths \\ Department of Computer Science}
